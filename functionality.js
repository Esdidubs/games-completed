...
function allGames(sortingNum) {
    ...
    for (let game in gameArr) {
        allGames += `<div class="game"><div class="title">${gameArr[game].title}</div><div class="year">${gameArr[game].yearReleased}</div><div class="rating">${gameArr[game].myRating}</div><div class="gameConsole">${gameArr[game].gameConsole}</div></div>`;
        gamesForAll += 1;
        ...
        for (let game in gameData) {
            if (gameData[game].gameConsole == undefined) {
                ...
                if (gameData[game].gameConsole.includes(gameConsoleArr[gameConsole]) == true) {
                    consoleGameList += `<div class="game"><div class="title">${gameData[game].title}</div><div class="year">${gameData[game].yearReleased}</div><div class="rating">${gameData[game].myRating}</div><div class="gameConsole">${gameData[game].gameConsole}</div></div>`;
